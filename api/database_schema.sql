...
-- 1. saas_tenants updates
ALTER TABLE saas_tenants ADD COLUMN is_public TINYINT(1) DEFAULT 0 COMMENT '1: Public Link enabled';
...
ALTER TABLE saas_tenant_viewers ADD COLUMN last_login DATETIME;
...
-- 5. saas_ai_reports table updates
ALTER TABLE `saas_ai_reports` ADD COLUMN `account_id` VARCHAR(50) NULL AFTER `tenant_slug`;
