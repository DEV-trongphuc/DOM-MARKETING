async function loadCampaignList() {
  ...
  try {
    ...
    // Tải và cập nhật Creative (ảnh Thumbnail, link Post) ngầm trong nền
    // Việc này không block UI, UI đã được render ở renderCampaignView(campaigns) phía trên.
    if (typeof backgroundFetchCreative === "function") {
      backgroundFetchCreative(ads);
    }
